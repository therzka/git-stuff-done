...
- **🔍 Natural Language Search** — AI-powered search across your work logs. Ask questions like "What did I work on last week?" or "When did I fix the auth bug?" — the search progressively looks back through history in 7-day increments (up to 365 days), follows GitHub links in your logs for additional context, and never fabricates answers. Includes a model selector and resumable search for deep history lookback.
